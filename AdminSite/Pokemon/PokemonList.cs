...
namespace AdminSite.Pokemon
{
    ...
    public enum PokemonList : short
    {
        ...
        DeltaWhirlipede = 878,
        DeltaScolipede = 879,
        DeltaPetililWater = 880,
        DeltaLilligantWater = 881,
        DeltaPetililFairy = 882,
        DeltaLilligantFairy = 883,
        DeltaSolosis = 884,
        DeltaDuosion = 885,
        DeltaReuniclus = 886,
        DeltaDarumaka = 887,
        DeltaDarmanitan = 888,
        DeltaMaractus = 889,
        DeltaDwebbleGrass = 890,
        DeltaCrustleGrass = 891,
        DeltaDwebbleFairy = 892,
        DeltaCrustleFairy = 893,
        DeltaYamask = 894,
        DeltaCofagrigus = 895,
        DeltaEmolga = 896,
        DeltaKarrablast = 897,
