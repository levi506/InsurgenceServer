...
namespace AdminSite.Pokemon
{
    public static class PokemonDatabase
    {
        ...
        {
            var s = File.ReadAllText("pokemon.json");
            Database = JsonConvert.DeserializeObject<List<PokemonData>>(s);
        }

        public static PokemonData GetData(int speciesID)
        {
            return Database.FirstOrDefault(x => x.id == speciesID);
        }
    }
    ...
    public class PokemonData
    {
        ...
        public List<string> Typing { get; set; }
        public Stats BaseStats { get; set; }
        public double GenderRatio { get; set; }
        public string GrowthRate { get; set; }
        public int BaseExp { get; set; }
        public Stats EVReward { get; set; }
        public int Catchrate { get; set; }
        public int BaseHappiness { get; set; }
        public List<string> Abilities { get; set; }
        public List<string> HiddenAbility { get; set; }
    ...
    public static class GrowthRates
    {
        ...
        {
            var datarate = PokemonDatabase.GetData(speciesId).GrowthRate;
            switch (datarate)
            {
                case "Erratic":
        ...
        public static int CalculateExp(int speciesID, int level)
        {
            ...
            {
                case "Parabolic":
                    return GrowthRatesLookup.Parabolic[level];
                case "Medium":
                    return GrowthRatesLookup.Medium[level];
                case "Fast":
                    return GrowthRatesLookup.Fast[level];
                case "Slow":
                    return GrowthRatesLookup.Slow[level];
                case "Fluctuating":
                    return GrowthRatesLookup.Fluctuating[level];
                case "Erratic":
                    return GrowthRatesLookup.Erratic[level];
                default:
                    return 1;
            }
        }
    ...
    {
        Parabolic, Medium, Fast, Slow, Fluctuating, Erratic
    }
    public static class GrowthRatesLookup
    {
        public static List<int> Erratic = new List<int>
        {
        ...
        public static List<int> Fast = new List<int>
        {
        ...
        public static List<int> Medium = new List<int>
        {
        ...
        public static List<int> Parabolic = new List<int>
        {
        ...
        public static List<int> Slow = new List<int>
        {
        ...
        public static List<int> Fluctuating = new List<int>
        {
